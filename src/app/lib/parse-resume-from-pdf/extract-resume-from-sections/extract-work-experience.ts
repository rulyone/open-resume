...
const JOB_TITLES = ['Accountant', 'Administrator', 'Advisor', 'Agent', 'Analyst', 'Apprentice', 'Architect', 'Assistant', 'Associate', 'Auditor', 'Bartender', 'Biologist', 'Bookkeeper', 'Buyer', 'Carpenter', 'Cashier', 'CEO', 'Clerk', 'Co-op', 'Co-Founder', 'Consultant', 'Coordinator', 'CTO', 'Developer', 'Designer', 'Director', 'Driver', 'Editor', 'Electrician', 'Engineer', 'Extern', 'Founder', 'Freelancer', 'Head', 'Intern', 'Janitor', 'Journalist', 'Laborer', 'Lawyer', 'Lead', 'Manager', 'Mechanic', 'Member', 'Nurse', 'Officer', 'Operator', 'Operation', 'Photographer', 'President', 'Producer', 'Recruiter', 'Representative', 'Researcher', 'Sales', 'Server', 'Scientist', 'Specialist', 'Supervisor', 'Teacher', 'Technician', 'Trader', 'Trainee', 'Treasurer', 'Tutor', 'Vice', 'VP', 'Volunteer', 'Webmaster', 'Worker',
                    'Contador',  'Administrador',  'Asesor',  'Agente',  'Analista',  'Aprendiz',  'Arquitecto', 'Asistente', 'Asociado', 'Auditor', 'Camarero', 'Biólogo', 'Contable', 'Comprador', 'Carpintero', 'Cajero', 'CEO', 'Empleado de oficina', 'Cooperativa', 'Co-fundador', 'Consultor', 'Coordinador', 'CTO', 'Desarrollador', 'Diseñador', 'Director', 'Conductor', 'Editor', 'Electricista', 'Ingeniero', 'Externo', 'Fundador', 'Freelancer', 'Jefe', 'Becario', 'Conserje', 'Periodista', 'Obrero', 'Abogado', 'Líder', 'Gerente', 'Mecánico', 'Miembro', 'Enfermero', 'Oficial', 'Operador', 'Operación', 'Fotógrafo', 'Presidente', 'Productor', 'Reclutador', 'Representante', 'Investigador', 'Ventas', 'Servidor', 'Científico', 'Especialista', 'Supervisor', 'Profesor', 'Técnico', 'Comerciante', 'Aprendiz', 'Tesorero', 'Tutor', 'Vice', 'Vicepresidente', 'Voluntario', 'Webmaster', 'Trabajador'];
